...
def loss_calculation(pred_r, pred_t, target, model_points, idx, points, num_point_mesh, sym_list, use_depth):
    ...
    t = ori_t[0]
    points = points.view(1, num_input_points, -1)
...
class Loss_refine(_Loss):
    ...
    def __init__(self, num_points_mesh, sym_list, use_depth):
    ...
    def forward(self, pred_r, pred_t, target, model_points, idx, points):
        return loss_calculation(pred_r, pred_t, target, model_points, idx, points, self.num_pt_mesh, self.sym_list, self.use_depth)
